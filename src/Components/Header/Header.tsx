...
const Header = ({ projectName, application }: HeaderProps) => (
  <div className="w-full text-left bg-mono/basic-16 font-normal h-full justify-center place-content-center gap-4 text-base pl-6">
    <nav aria-label="breadcrumb">
      <div className="flex w-full flex-wrap items-center rounded-md bg-blue-gray-50 bg-opacity-60 py-2 text-headline-xs">
        <Typography
          className={` transition-all duration-300 text-secondary opacity-80 pr-3`}
          children={"RCS Platform"}
        />
        <div className="flex cursor-pointer items-center font-sans text-base font-normal leading-normal antialiased transition-colors duration-100 text-mono/basic-4 bg-mono/basic-14 rounded-full">
          <div className="group flex items-center px-4 gap-4">
            <Typography
